...
<head>
    ...
    <link rel="stylesheet"
          href="<?= base_url('activos/css/espectaculo_logueado/body_espectaculo_logueado.css'); ?>">
</head>

<body>

<div class="fondo-body"
     style="background-image: url('<?= htmlspecialchars($fondo); ?>');"></div>
...
<main class="container">
    ...
    <section class="card">
        ...
        <h1 class="titulo-espectaculo">
            <?= htmlspecialchars($espectaculo['nombre']); ?>
        </h1>

        <p class="descripcion">
            <?= htmlspecialchars($espectaculo['descripcion']); ?>
        </p>
        ...
        <div class="card-bottom">
            ...
            <?php if ($espectaculo['disponibles'] > 0): ?>
                <form method="post"
                      action="<?= site_url('reservar/procesar_reserva/' . $espectaculo['id_espectaculo']); ?>"
                      class="formulario">
                    ...
                    <div class="botones">
                        ...
                        <a href="<?= site_url('usuario/usuario_espectaculos'); ?>"
                           class="btn volver">Ir a Espectáculos</a>
                    </div>
                </form>
            <?php else: ?>
    ...
    <section class="mapa-section">
        ...
        <div class="mapa-externa">
            <img src="<?= base_url('activos/imagenes/mapa.jfif'); ?>" alt="Mapa del lugar">
        </div>
