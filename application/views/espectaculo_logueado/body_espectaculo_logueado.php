...
<body>
    ...
    <main class="container">
        ...
        <section class="card">
            ...
            <!-- Título -->
            <h1 class="titulo-espectaculo"><?= htmlspecialchars($espectaculo['nombre']); ?></h1>

            <!-- Descripción -->
            <p class="descripcion descripcion-principal"><?= htmlspecialchars($espectaculo['descripcion']); ?></p>

            <!-- Imagen de artista/evento -->
            ...
            <div class="card-bottom">
                <p class="entradas">
                    Entradas disponibles: <strong><?= htmlspecialchars($espectaculo['disponibles']); ?></strong>
                </p>
                ...
                <?php if ($espectaculo['disponibles'] > 0): ?>
                    <form method="post" action="<?= site_url('reservar/procesar_reserva/' . $espectaculo['id_espectaculo']); ?>" class="formulario">
        ...
        <section class="mapa-section">
            ...
            <p class="mapa-texto texto-debajo-mapa">
