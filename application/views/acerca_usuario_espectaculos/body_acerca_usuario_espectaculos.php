...
<head>
    ...
    <!-- Enlace al CSS -->-
    <link rel="stylesheet" href="<?= base_url('activos/css/acerca_usuario/body_acerca_usuario.css'); ?>">
</head>
    ...
    <main class="main-content">
        <div class="cuadro-ayuda text-center text-white">
            ...
            <div class="volver-inicio">
                ...
                <a href="<?= site_url('usuario/usuario_espectaculos'); ?>" class="btn btn-celeste">
